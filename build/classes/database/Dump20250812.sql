...
INSERT INTO `funcionarios` VALUES (42,'1','1','1',1,1);
...
CREATE TABLE `vendas` (
  ...
  `hora` time NOT NULL,
  PRIMARY KEY (`id`),
  KEY `vendas_ibfk_1` (`produto_id`),
  KEY `vendas_ibfk_2` (`funcionario_id`),
  KEY `vendas_ibfk_3` (`cliente_id`),
...
-- Dump completed on 2025-08-12 20:55:38
